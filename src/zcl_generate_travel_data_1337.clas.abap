CLASS zcl_generate_travel_data_1337 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_1337 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_1337.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_1337.

*   insert the new table entries
    INSERT ztravel_1337 FROM TABLE @itab.
